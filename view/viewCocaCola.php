  ...
  <body id="bodyColor">
      ...
      <nav id="headerColor" class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <!-- Dropdown -->
                  <li class="nav-item">
                      <a id="navModels" class="nav-link"  href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="X3D Models" data-content="There are three X3D models: Dr Pepper, Coca Cola and Fanta">Models</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="container-fluid">
          ...
          <div id="home" class="main_contents">
            ...
            <!-- A row to hold three cards for the Nestea, Coke and Fanta contents -->
            <div class="row">
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="../application/assets/images/renderImages/pepper.jpg" data-fancybox data-caption="My 3D Pepper Can Render" class="thumbnail">
                  ...
                  <div class="col-sm-4">
                      <div class="card">
                          <a href="../application/assets/images/renderImages/coke.jpg" data-fancybox data-caption="My 3D Coca Cola Bottle Render" class="img-narrow">
                  ...
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="../application/assets/images/renderImages/fanta.jpg" data-fancybox data-caption="My 3D Fanta Cup Render">
                          ...
                          <div class="card-body">
                            ...
                            <a href="http://www.coca-cola.co.uk/drinks/fanta" class="btn btn-primary btn-responsive">Find out more ...</a>                 
                          </div>
                      </div>
                  </div>
                ...
                <div class="card text-left">
                  ...
                  <div class="card-body">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-success btn-responsive" onMouseUp="cokeScene(); cokeDescription();">Dr Pepper</button>
                        <button type="button" class="btn btn-success btn-responsive" onMouseUp="spriteScene(); spriteDescription();">Coca cola</button>
              ...
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                        ...
                        <a href="http://www.coca-cola.co.uk/drinks/coca-cola/coca-cola" class="btn btn-primary btn-responsive">Visit Coca Cola</a>                 
                      </div>
                  </div>
              </div>
      ...
      <nav id="footerColor" class="navbar navbar-expand-sm footer">
          <div class="container-fluid">   
              ...
              <div class="navbar-text float-right social">
                  <a href="https://github.com/matri19/Web3DApplicationAssignment"><i class="fab fa-github-square fa-2x"></i></a>
              </div>
          </div>
      </nav> 
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Candidate number:215808  Email: mmz22@sussex.ac.uk</p>
                </div>
